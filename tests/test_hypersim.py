...
def mock_field():
    ...
    class MockField:
        def __init__(self, ndim=2, bits=6, rank=8):
            ...
            # Create mock cores
            self.cores = [
                torch.randn(rank, 2, rank) for _ in range(self.total_bits)
            ]
...
class TestRewardFunctions:
    ...
    def test_shaped_reward(self, mock_field):
        ...
        from tensornet.hypersim.rewards import ShapedReward, DenseReward
...
class TestSpaces:
    ...
    def test_observation_config(self):
        ...
        from tensornet.hypersim.spaces import ObservationConfig, ObservationType
    ...
    def test_field_observation_shape(self):
        ...
        from tensornet.hypersim.spaces import FieldObservation, ObservationConfig, ObservationType
    ...
    def test_action_config(self):
        ...
        from tensornet.hypersim.spaces import ActionConfig, ActionType, ActuatorConfig
        import numpy as np
    ...
    def test_field_action_shape(self):
        ...
        from tensornet.hypersim.spaces import FieldAction, ActionConfig, ActionType
    ...
    def test_action_mask(self, mock_field):
        """Test action masking."""
        from tensornet.hypersim.spaces import ActionMask, ActionConfig, ActionType, ActuatorConfig
        import numpy as np
...
class TestCurriculum:
    ...
    def test_curriculum_progression(self):
        ...
        stages = [
            CurriculumStage("easy", viscosity=0.1, min_episodes=10, success_threshold=0.5),
            CurriculumStage("hard", viscosity=0.01, min_episodes=10, success_threshold=0.8),
        ]
    ...
    def test_domain_randomizer(self):
        ...
        from tensornet.hypersim.curriculum import DomainRandomizer, RandomizationRange
...
class TestWrappers:
    ...
    def test_make_wrapped_env(self, mock_gymnasium):
        ...
        class MockEnv:
            ...
            def step(self, action):
                return np.random.randn(3, 64, 64).astype(np.float32), 1.0, False, False, {}
...
class TestRegistry:
    ...
    def test_register_and_make(self):
        ...
        from tensornet.hypersim.registry import register_env, make_env, unregister_env, list_envs
...
class TestIntegration:
    ...
    def test_import_all(self):
        ...
        from tensornet.hypersim import (
            # Environment
            FluidEnv,
            FluidEnvConfig,
            EnvState,
    ...
    def test_full_workflow(self, mock_field):
        ...
        from tensornet.hypersim.rewards import DenseReward
        from tensornet.hypersim.curriculum import Curriculum, CurriculumStage
        from tensornet.hypersim.spaces import FieldObservation, ObservationConfig
