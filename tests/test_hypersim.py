...
class TestRewardFunctions:
    ...
    def test_sparse_reward(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import SparseReward
    ...
    def test_dense_reward(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import DenseReward
    ...
    def test_composite_reward(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import CompositeReward, DenseReward
    ...
    def test_shaped_reward(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import DenseReward, ShapedReward
    ...
    def test_energy_reward(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import EnergyReward
    ...
    def test_vorticity_reward(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import VorticityReward
    ...
    def test_dissipation_reward(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import DissipationReward
    ...
    def test_reward_scaling(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import DenseReward, RewardConfig
    ...
    def test_make_reward_factory(self, mock_field):
        ...
        from ontic.infra.hypersim.rewards import make_reward
...
class TestSpaces:
    ...
    def test_observation_config(self):
        ...
        from ontic.infra.hypersim.spaces import (ObservationConfig,
                                               ObservationType)
    ...
    def test_field_observation_shape(self):
        ...
        from ontic.infra.hypersim.spaces import (FieldObservation,
                                               ObservationConfig,
                                               ObservationType)
    ...
    def test_action_config(self):
        ...
        from ontic.infra.hypersim.spaces import (ActionConfig, ActionType,
                                               ActuatorConfig)
    ...
    def test_action_mask(self, mock_field):
        ...
        from ontic.infra.hypersim.spaces import (ActionConfig, ActionMask,
...
class TestCurriculum:
    ...
    def test_curriculum_stage(self):
        ...
        from ontic.infra.hypersim.curriculum import CurriculumStage
    ...
    def test_curriculum_progression(self):
        ...
        from ontic.infra.hypersim.curriculum import Curriculum, CurriculumStage
    ...
    def test_domain_randomizer(self):
        ...
        from ontic.infra.hypersim.curriculum import (DomainRandomizer,
                                                   RandomizationRange)
    ...
    def test_difficulty_scheduler(self):
        ...
        from ontic.infra.hypersim.curriculum import DifficultyScheduler
    ...
    def test_make_fluid_curriculum(self):
        ...
        from ontic.infra.hypersim.curriculum import make_fluid_curriculum
...
class TestWrappers:
    ...
    def test_frame_stack(self, mock_gymnasium):
        ...
        from ontic.infra.hypersim.wrappers import FrameStack
    ...
    def test_action_repeat(self, mock_gymnasium):
        ...
        from ontic.infra.hypersim.wrappers import ActionRepeat
    ...
    def test_reward_scaling(self, mock_gymnasium):
        ...
        from ontic.infra.hypersim.wrappers import RewardScaling
    ...
    def test_time_limit(self, mock_gymnasium):
        ...
        from ontic.infra.hypersim.wrappers import TimeLimit
    ...
    def test_record_episode(self, mock_gymnasium):
        ...
        from ontic.infra.hypersim.wrappers import RecordEpisode
    ...
    def test_make_wrapped_env(self, mock_gymnasium):
        ...
        from ontic.infra.hypersim.wrappers import make_wrapped_env
...
class TestRegistry:
    ...
    def test_register_and_make(self):
        ...
        from ontic.infra.hypersim.env import FluidEnv
        from ontic.infra.hypersim.registry import (list_envs, make_env,
    ...
    def test_list_envs(self):
        ...
        from ontic.infra.hypersim.registry import list_envs
    ...
    def test_get_env_spec(self):
        ...
        from ontic.infra.hypersim.registry import get_env_spec
    ...
    def test_make_fluid_env_convenience(self):
        ...
        from ontic.infra.hypersim.registry import make_fluid_env
    ...
    def test_task_specs(self):
        ...
        from ontic.infra.hypersim.registry import TASK_SPECS, TaskSpec
...
class TestFluidEnv:
    ...
    def test_env_config(self):
        ...
        from ontic.infra.hypersim.env import FluidEnvConfig
    ...
    def test_env_state(self):
        ...
        from ontic.infra.hypersim.env import EnvState
    ...
    def test_step_result(self):
        ...
        from ontic.infra.hypersim.env import StepResult
...
class TestIntegration:
    ...
    def test_import_all(self):
        ...
        from ontic.infra.hypersim import (  # Environment; Rewards; Spaces; Curriculum; Wrappers; Registry
