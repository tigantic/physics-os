...
from tensornet.racing.wake import (
    WakeTracker,
    DirtyAirReport,
)
...
class TestWakeUpdate:
    ...
    def test_crosswind_shifts_wake(self, deterministic_seed):
        ...
        tracker_no_wind.update_wake(lead_car_x=25, lead_car_speed_kmh=300, crosswind_ms=0)
