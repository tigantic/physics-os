...
def test_query_on_physics():
    ...
    from tensornet.intent import Aggregator, FieldQuery, Predicate
...
def test_constraint_solver():
    ...
    from tensornet.intent import (BoundConstraint, ConstraintSet,
                                  ConstraintSolver)
...
def test_intent_engine_integration():
    ...
    from tensornet.intent import (Aggregator, FieldQuery, IntentEngine,
                                  ResultStatus)
