...
from tensornet.defense.ballistics import (
    BallisticSolver,
    BallisticSolution,
)
...
class TestBallisticsIntegration:
    ...
    def test_uphill_vs_downhill(self, deterministic_seed):
        ...
        sol_uphill = solver.solve_trajectory(1000.0, target_elevation=100.0, verbose=False)
        sol_downhill = solver.solve_trajectory(1000.0, target_elevation=-100.0, verbose=False)
