...
class TestAgent:
    ...
    def test_agent_config_defaults(self):
        ...
        from tensornet.hyperenv import AgentConfig
    ...
    def test_agent_state_serialization(self):
        ...
        from tensornet.hyperenv import AgentState
    ...
    def test_constant_agent(self):
        ...
        from tensornet.hyperenv import ConstantAgent
    ...
    def test_agent_train_eval_mode(self):
        ...
        from tensornet.hyperenv import RandomAgent
...
class TestMultiAgent:
    ...
    def test_multiagent_config(self):
        ...
        from tensornet.hyperenv import MultiAgentConfig, TeamConfig, AgentRole
    ...
    def test_multiagent_env_creation(self):
        ...
        from tensornet.hyperenv import MultiAgentEnv, MultiAgentConfig, TeamConfig
        ...
        config = MultiAgentConfig(
            teams=[TeamConfig(name="team", size=2)]
        )
    ...
    def test_multiagent_reset(self):
        ...
        config = MultiAgentConfig(
            teams=[TeamConfig(name="team", size=3)]
        )
    ...
    def test_multiagent_step(self):
        ...
        from tensornet.hyperenv import MultiAgentEnv, MultiAgentConfig, TeamConfig, AgentRole
        ...
        actions = {
            agent_id: np.zeros(4)
            for agent_id in multi_env.agent_ids
        }
...
class TestTrainer:
    ...
    def test_trainer_config_defaults(self):
        ...
        from tensornet.hyperenv import TrainerConfig
    ...
    def test_training_state_serialization(self):
        ...
        from tensornet.hyperenv import TrainingState
    ...
    def test_trainer_stop(self):
        ...
        from tensornet.hyperenv import Trainer, RandomAgent, TrainerConfig, LambdaCallback
...
class TestEvaluator:
    ...
    def test_evaluation_result(self):
        ...
        from tensornet.hyperenv import EvaluationResult
    ...
    def test_evaluator_evaluate(self):
        ...
        from tensornet.hyperenv import Evaluator, RandomAgent
    ...
    def test_benchmark_suite(self):
        ...
        from tensornet.hyperenv import BenchmarkSuite, RandomAgent
        ...
        def make_mock_env():
            env = MagicMock()
            env.reset.return_value = (np.zeros(10), {})
            env.step.return_value = (np.zeros(10), 1.0, True, False, {})  # Immediate done
            return env
...
class TestCallbacks:
    ...
    def test_callback_list(self):
        ...
        from tensornet.hyperenv import CallbackList, Callback
    ...
    def test_early_stopping_callback(self):
        ...
        from tensornet.hyperenv import EarlyStoppingCallback, TrainingState
    ...
    def test_lambda_callback(self):
        ...
        from tensornet.hyperenv import LambdaCallback
        
        steps = []
        
        callback = LambdaCallback(
            on_step=lambda t: steps.append(t.state.timestep)
        )
...
class TestBuffers:
    ...
    def test_experience_namedtuple(self):
        ...
        from tensornet.hyperenv import Experience
    ...
    def test_trajectory(self):
        ...
        from tensornet.hyperenv import Trajectory
    ...
    def test_prioritized_replay_buffer(self):
        ...
        from tensornet.hyperenv import PrioritizedReplayBuffer
    ...
    def test_rollout_buffer(self):
        ...
        from tensornet.hyperenv import RolloutBuffer
    ...
    def test_batch_to_torch(self):
        ...
        from tensornet.hyperenv import Batch
...
class TestIntegration:
    ...
    def test_agent_to_trainer_pipeline(self):
        ...
        from tensornet.hyperenv import (
            RandomAgent, Trainer, TrainerConfig, ReplayBuffer
        )
    ...
    def test_multiagent_with_random_agents(self):
        ...
        from tensornet.hyperenv import (
            MultiAgentEnv, MultiAgentConfig, TeamConfig,
            RandomAgent
        )
    ...
    def test_evaluate_trained_agent(self):
        ...
        from tensornet.hyperenv import (
            RandomAgent, Trainer, TrainerConfig, Evaluator
        )
    ...
    def test_callback_with_trainer(self):
        ...
        from tensornet.hyperenv import (
            RandomAgent, Trainer, TrainerConfig, LambdaCallback
        )
