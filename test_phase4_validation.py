...
def test_imports():
    ...
    try:
        from tensornet.sovereign.qtt_slice_extractor import QTTSliceExtractor, QTT3DState
    ...
    if tests_failed == 0:
        ...
        print("  2. In another terminal: cd glass-cockpit && cargo run --release --bin phase3")
        return True
    else:
