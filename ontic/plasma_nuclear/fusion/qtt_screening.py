...
# =============================================================================
# FALLBACK TT-SVD (when ontic.cfd.qtt_eval unavailable)
# =============================================================================
...
# =============================================================================
# TCI FALLBACK (when ontic.cfd.qtt_tci unavailable)
# =============================================================================
...
class QTTElectronScreeningSolver:
    ...
    def compute_electron_density_qtt(
        ...
        Falls back to internal implementations if ontic.cfd.qtt_tci unavailable.
