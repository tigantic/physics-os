...
This module delegates to ``ontic.cfd.qtt_tci`` for the actual
...
from ontic.platform.data_model import FieldData, Mesh, StructuredMesh
from ontic.platform.qtt import QTTFieldData, _next_power_of_2
...
def tci_from_function(
    ...
    try:
        ...
        values = f(indices)
        from ontic.platform.qtt import _tt_svd
