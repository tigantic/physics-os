...
from ontic.platform.domain_pack import DomainRegistry, get_registry
from ontic.platform.export import ExportBundle, export_csv, export_vtu
from ontic.platform.lineage import LineageDAG, LineageEvent, LineageTracker
from ontic.platform.protocols import Observable, Solver, SolveResult, WorkflowResult
        ...
        with ReproducibilityContext(seed=cfg.seed) as repro:
            ...
            for espec in cfg.exports:
                if espec.format == "vtu":
                    ...
                    from ontic.platform.export import export_xdmf_hdf5
