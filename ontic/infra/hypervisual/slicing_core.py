...
from ontic.engine.substrate.morton_ops import (
...
class MortonSlicer:
    ...
    def __init__(self, field: Field):
        ...
        Args:
            field: A 3D Field from ontic.substrate
        """
        self.field = field
...
def compare_slicing_methods(field: Field, z_index: int = None) -> dict[str, Any]:
    """
    ...
    """
    from ontic.infra.hypervisual.slicer import SliceEngine
    ...
    spec = SliceSpec(plane="xy", z_coord=z_depth, resolution=(N, N))
