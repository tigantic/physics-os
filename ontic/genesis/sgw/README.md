...
```python
from ontic.genesis.sgw import QTTLaplacian
...
```python
from ontic.genesis.sgw import QTTGraphWavelet
...
```python
from ontic.genesis.sgw import LowPassFilter, HighPassFilter, BandPassFilter
