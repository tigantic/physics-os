...
from ontic.genesis.ga.products import (
    geometric_product, outer_product, scalar_product
)
from ontic.genesis.ga.operations import (
...
def rotor_sqrt(R: Multivector) -> Multivector:
    ...
    from ontic.genesis.ga.operations import exp
    return exp(log_R / 2)
...
def euler_to_rotor(yaw: float, pitch: float, roll: float,
    ...
    from ontic.genesis.ga.multivector import bivector
