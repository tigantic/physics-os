...
# Import from ontic core - use relative imports for flexibility
try:
    from ontic.core.qtt import QTT, qtt_round, qtt_add, qtt_hadamard
    from ontic.core.decompositions import tt_decompose
except ImportError:
