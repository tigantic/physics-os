"""
Sphinx Configuration Generator for Project The Ontic Engine.
...
class SphinxConfig:
    ...
    def get_default_extensions() -> list[SphinxExtension]:
        """Get default Sphinx extensions for The Ontic Engine.
...
def generate_conf_py(
    ...
    lines = [
        ...
        "",
        "Auto-generated by The Ontic Engine documentation module.",
        '"""',
        "",
        "import os",
        "import sys",
    ...
    if config.theme == SphinxTheme.FURO:
        ...
        lines.append('    "github_url": "https://github.com/tigantic/physics-os",')
