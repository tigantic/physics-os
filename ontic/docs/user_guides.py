...
""",
    ...
    builder.add_example(
        """
import torch
from ontic import MPS, heisenberg_mpo, run_dmrg
...
""",
    ...
    builder.add_example(
        """
from ontic.cfd import Euler1D, sod_shock_tube_ic
...
""",
    ...
    builder.add_example(
        """
from ontic.cfd import Euler1D, EulerState
import torch
...
""",
    ...
    builder.add_example(
        """
from ontic.cfd import Euler2D, supersonic_wedge_ic
...
""",
    ...
    builder.add_example(
        """
from ontic.cfd import NavierStokes2D, NavierStokes2DConfig
...
""",
    ...
    builder.add_example(
        """
from ontic.cfd.qtt import euler_to_qtt, qtt_to_euler, compression_analysis
...
""",
    ...
    builder.add_example(
        """
from ontic import heisenberg_mpo, run_dmrg
...
""",
    ...
    builder.add_example(
        """
from ontic.infra.deployment import (
    TensorRTExporter,
    ExportConfig,
    Precision,
    OptimizationLevel,
