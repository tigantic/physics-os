...
from ontic.genesis.sgw import QTTSignal, QTTLaplacian

# Type system
from ontic.types.spaces import Space, EuclideanSpace, R3
from ontic.types.constraints import Constraint, Divergence, Curl
