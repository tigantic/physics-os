...
Integration:
    - ontic.fusion.tokamak: Boris pusher particle simulation
    - ontic.fusion.marrs_simulator: MARRS solid-state fusion
...
class PlasmaDiscoveryPipeline:
    ...
    def simulate_confinement(
        ...
        Uses ontic.fusion.TokamakReactor for real particle-in-cell
    ...
    def _detect_anomalies_rkhs(
        ...
        from ontic.genesis.rkhs import RBFKernel
    ...
    def _analyze_topology_ph(
        ...
        from ontic.genesis.topology import RipsComplex
        from ontic.genesis.topology.boundary import betti_numbers_from_boundary
    ...
    def _analyze_symmetry_ga(
        ...
        from ontic.genesis.ga import CliffordAlgebra, vector
    ...
    def _generate_markdown_report(self, result: PlasmaPipelineResult) -> str:
        ...
        lines.extend([
            "---",
            "",
            "*Generated by Ontic Autonomous Discovery Engine - Phase 2: Fusion Plasma*",
        ])
