...
Wraps ontic.genesis.topology for persistent homology:
...
from ontic.ml.discovery.config import get_config
...
class TopologyPrimitive(GenesisPrimitive):
    ...
    Example:
        >>> from ontic.ml.discovery.primitives import TopologyPrimitive
        >>> 
