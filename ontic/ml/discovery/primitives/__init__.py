...
from ontic.ml.discovery.primitives.optimal_transport import OptimalTransportPrimitive
from ontic.ml.discovery.primitives.spectral_wavelets import SpectralWaveletPrimitive
from ontic.ml.discovery.primitives.random_matrix import RandomMatrixPrimitive
from ontic.ml.discovery.primitives.kernel import KernelPrimitive
from ontic.ml.discovery.primitives.topology import TopologyPrimitive
from ontic.ml.discovery.primitives.geometric_algebra import GeometricAlgebraPrimitive
