...
1. ontic.fusion.TokamakReactor — Boris pusher particle simulation
...
class FusionConnector:
    ...
    Integrates:
    - ontic.fusion.TokamakReactor (Boris pusher)
    ...
    def reactor(self):
        ...
        if self._reactor is None:
            from ontic.plasma_nuclear.fusion import TokamakReactor
