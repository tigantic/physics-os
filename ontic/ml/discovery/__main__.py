...
Usage:
    python -m ontic.discovery --help
    python -m ontic.discovery discover --domain defi --demo
    python -m ontic.discovery test
"""
...
def cmd_info(args):
    ...
    print()
    print("Usage:")
    print("  python -m ontic.discovery discover --domain defi --demo")
    print("  python -m ontic.discovery discover --domain plasma --demo")
    print("  python -m ontic.discovery discover --domain molecular --demo")
    print("  python -m ontic.discovery discover --domain markets --demo")
    print("  python -m ontic.discovery live --mode historical --event flash-crash-2010")
    print("  python -m ontic.discovery live --mode replay --event gme-2021")
    print("  python -m ontic.discovery live --mode stream --duration 30")
    print("  python -m ontic.discovery serve --port 8000")
    print("  python -m ontic.discovery test")
    print()
