...
Dependencies
------------
- ontic.em.qtt_3d: 3D QTT operators, solver, geometry
- ontic.em.qtt_helmholtz: Core QTT algebra, DMRG solver
- ontic.em.boundaries: PMLConfig, _compute_pml_stretching
- ontic.em.topology_opt: Heaviside, density filter, binarisation
"""
