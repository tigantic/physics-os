...
Wraps ontic.optics.physical_optics.FresnelPropagator for STARK tracing.
...
class PhysicalOpticsTraceAdapter:
    ...
    Wraps FresnelPropagator from ontic.applied.optics.physical_optics.
    ...
    def __init__(
        ...
        from ontic.applied.optics.physical_optics import FresnelPropagator
