...
from ontic.engine.fuel.tile_compositor import TileCompositor, TileConfig
from ontic.engine.gateway.modular_grid import HUDCorner, ModularGrid
from ontic.engine.gateway.onion_renderer import LayerType, OnionRenderer

# Phase 4: Gateway UI/UX
from ontic.engine.gateway.photonic_discipline import PhotonicPalette

# Phase 2: GPU Tensor Infrastructure
from ontic.engine.gpu.tensor_field import TensorField
from ontic.mpo import MPOAtmosphericSolver

# Phase 4.5: QTT Hybrid Rendering (rSVD-accelerated)
from ontic.quantum.hybrid_qtt_renderer import HybridQTTRenderer
