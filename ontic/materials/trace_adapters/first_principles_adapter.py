...
Wraps ontic.materials.first_principles_design.BirchMurnaghanEOS for STARK tracing.
...
class FirstPrinciplesTraceAdapter:
    ...
    def __init__(
        ...
        from ontic.materials.first_principles_design import BirchMurnaghanEOS
