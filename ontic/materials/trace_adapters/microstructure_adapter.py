...
Wraps ontic.materials.microstructure.MultiPhaseFieldGrainGrowth for STARK tracing.
...
class MicrostructureTraceAdapter:
    ...
    def __init__(
        ...
        from ontic.materials.microstructure import MultiPhaseFieldGrainGrowth
