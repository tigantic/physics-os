...
from ontic.cfd.nd_shift_mpo import apply_nd_shift_mpo
...
def compute_euler_flux_x(
    ...
    """
    from ontic.cfd.qtt_hadamard import qtt_hadamard
    from ontic.cfd.qtt_reciprocal import qtt_reciprocal
