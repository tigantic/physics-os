...
class SpectralDerivatives3D:
    ...
    def curl(self, u: 'QTT3DVectorNative') -> 'QTT3DVectorNative':
        """Spectral curl: ω = ∇ × u."""
        from ontic.cfd.ns3d_native import QTT3DVectorNative
...
def test_spectral_vs_finite_diff():
    ...
    from ontic.cfd.ns3d_native import taylor_green_analytical, NativeDerivatives3D
...
def benchmark_spectral_vs_native():
    ...
    import time as pytime
    from ontic.cfd.ns3d_native import taylor_green_analytical, NativeNS3DSolver, NativeNS3DConfig
