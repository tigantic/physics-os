...
from ontic.cfd.nd_shift_mpo import apply_nd_shift_mpo, apply_nd_shift_mpo_batched, make_nd_shift_mpo
...
# from ontic.cfd.tt_poisson import poisson_solve_cg_2d
...
class NS2D_QTT_Native:
    ...
    def enable_cuda(self) -> bool:
        ...
        1. QTT native ops (hadamard, inner product) via ontic.cuda
        ...
        try:
            from ontic.cuda.qtt_native_ops import enable_cuda_backend, is_cuda_available
        ...
        try:
            from ontic.cfd.nd_shift_mpo import enable_cuda_shifts, cuda_shift_available
    ...
    def disable_cuda(self):
        ...
        try:
            from ontic.cuda.qtt_native_ops import disable_cuda_backend
            disable_cuda_backend()
        except ImportError:
            pass
        
        try:
            from ontic.cfd.nd_shift_mpo import disable_cuda_shifts
            disable_cuda_shifts()
        except ImportError:
            pass
