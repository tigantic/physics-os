...
Wraps ontic.chemistry.nonadiabatic.FewestSwitchesSurfaceHopping for STARK tracing.
...
class NonadiabaticTraceAdapter:
    ...
    def __init__(
        ...
        from ontic.life_sci.chemistry.nonadiabatic import FewestSwitchesSurfaceHopping
