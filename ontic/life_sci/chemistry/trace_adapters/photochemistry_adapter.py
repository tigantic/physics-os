...
Wraps ontic.chemistry.photochemistry.FranckCondonFactors and InternalConversion
...
class PhotochemistryTraceAdapter:
    ...
    def __init__(self, S: float = 1.0) -> None:
        from ontic.life_sci.chemistry.photochemistry import FranckCondonFactors
    ...
    def ic_rate(
        ...
        rate, session
        """
        from ontic.life_sci.chemistry.photochemistry import InternalConversion
