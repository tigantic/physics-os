...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python tools/tools/scripts/ahmed_body_ib_solver.py --n-bits 7 --steps 200
  python tools/tools/scripts/ahmed_body_ib_solver.py --n-bits 8 --max-rank 64 --steps 500
  python tools/tools/scripts/ahmed_body_ib_solver.py --case-file ahmed_body_data/dataset/test_info/case100_info.txt
        """,
    )
