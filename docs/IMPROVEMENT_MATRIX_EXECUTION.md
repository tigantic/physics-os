...
**File:** `scripts/ahmed_body_ib_solver.py` (1,016 lines)
...
**File:** `scripts/trustless_physics.py` (1,624 lines) · **Version:** 2.0.0
...
**File:** `scripts/run_trustless_ahmed.py` (202 lines)
...
**File:** `scripts/generate_pdf_report.py` (1,353 lines)
...
|---|---|---|---|
| `scripts/ahmed_body_ib_solver.py` | 1,016 | NS3D QTT solver with IB Ahmed body | **Modified** |
| `tensornet/cfd/qtt_native_ops.py` | 1,368 | Core QTT tensor operations | **Modified** |
| `scripts/trustless_physics.py` | 1,624 | Trustless proof engine v2.0.0 | **Modified** |
...
| `scripts/run_trustless_ahmed.py` | 202 | CLI runner + offline verification | **Modified** |
| `scripts/generate_pdf_report.py` | 1,353 | PDF report generation | **Modified** |
| **Total** | **7,559** | | |
