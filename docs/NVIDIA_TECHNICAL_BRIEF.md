...
```bash
python scripts/run_trustless_ahmed.py --verify ahmed_ib_results/512/trustless_certificate.json
```
...
PYTHONPATH="$PWD:$PYTHONPATH" python scripts/gauntlet_vs_nvidia.py \
