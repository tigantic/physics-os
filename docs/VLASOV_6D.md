...
# Set PYTHONPATH
export PYTHONPATH="QTeneT/src/qtenet:$PWD:$PYTHONPATH"

# Quick smoke (4^6 = 4096 points, 5 steps)
python scripts/vlasov_6d_video.py \
...
| File | Lines | Purpose |
|------|-------|---------|
| `QTeneT/src/qtenet/qtenet/solvers/vlasov6d_genuine.py` | ~1000 | Genuine 6D solver |
| `QTeneT/src/qtenet/qtenet/solvers/vlasov_genuine.py` | ~1265 | 1D+1V reference solver |
| `scripts/vlasov_6d_video.py` | ~1124 | Video + STARK + TPC pipeline |
