...
| `proof_engine/` | 2,688 | 6 | Documented in Physics Inventory §34 |
| `tensornet/coordination/` | 2,227 | 4 | Documented in Physics Inventory §35 |
| `sdk/` proof examples | 1,832 | 2 | Documented |
| `fluidelite-core/` (Rust) | 1,976 | ~8 | Documented |
| `scripts/` (physics validation) | 1,647 | 5 | Documented |
...
| X.5 | Perturbative QFT | ✅ | `tensornet/qft/perturbative.py`, `proof_engine/constructive_qft.py` | 1-loop Feynman, MS-bar renormalization, QED vertex, running coupling |
