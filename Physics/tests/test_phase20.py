...
def test_coverage_analyzer():
    ...
    from tensornet.certification import CoverageAnalyzer, CoverageType, DAL
...
def test_hardware_specs():
    ...
    from tensornet.certification import HARDWARE_PRESETS
...
def test_quantization():
    ...
    from tensornet.certification import ModelQuantizer, QuantizationConfig, Precision
...
def test_realtime_scheduler():
    ...
    from tensornet.certification import TaskSpec, RealTimeScheduler
...
def test_wcet_analyzer():
    ...
    from tensornet.certification import WCETAnalyzer, HARDWARE_PRESETS
...
def test_hil_validator():
    ...
    from tensornet.certification import HILValidator, HARDWARE_PRESETS
