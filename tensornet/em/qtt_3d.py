...
Dependencies
------------
- ``tensornet.vm.operators``: ``identity_mpo``, ``_embed_1d_mpo``
- ``tensornet.em.qtt_helmholtz``: ``array_to_tt``, ``diag_mpo_from_tt``,
  ``mpo_add_c``, ``mpo_scale_c``, ``tt_amen_solve``, ``reconstruct_1d``
- ``tensornet.em.boundaries``: ``PMLConfig``, ``stretched_laplacian_mpo_1d``
"""
...
from tensornet.engine.vm.operators import identity_mpo, _embed_1d_mpo
...
def build_conductivity_eps_tt(
    ...
    from tensornet.em.chu_limit import simp_sigma
