...
class TileCoord:
    ...
    def __eq__(self, other) -> bool:
        if not isinstance(other, TileCoord):
            return False
        return (self.x, self.y, self.z, self.lod) == (other.x, other.y, other.z, other.lod)
...
class RenderConfig:
    ...
    # Quality controls
    max_rank: Optional[int] = None     # Rank cap for rendering
...
class TileCache:
    ...
    def get(self, coord: TileCoord) -> Optional[Tile]:
        """Get tile from cache."""
        key = coord.key
