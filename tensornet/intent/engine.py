...
from .goals import ActionPlan, Goal, GoalDirector, GoalStatus
from .parser import IntentParser, IntentType, ParseResult
...
class ExecutionContext:
    ...
    @property
    def last_result(self) -> IntentResult | None:
        """Get last result."""
...
class IntentEngine:
    ...
    def execute(
        self,
        intent: str | ParseResult | FieldQuery | Goal,
        **kwargs,
    ) -> IntentResult:
        """
        Execute an intent.
    ...
    def _handle_query_comparison(
        ...
        **kwargs,
        ...
        comparison = {
            ...
            "correlation": (
                float(np.corrcoef(data1.flatten(), data2.flatten())[0, 1])
    ...
    def _handle_control_start(
        ...
        **kwargs,
        ...
        if action_name and action_name in self.context.actions:
            # Execute action
            field = (
                list(self.context.fields.values())[0] if self.context.fields else None
            )
...
- Optimization: "minimize drag", "optimize pressure"
    ...
    def _handle_status(
        ...
        **kwargs,
        ...
        status = {
            ...
            "num_constraints": (
                len(self.context.constraints) if self.context.constraints else 0
            ),
    ...
    def _execute_goal(
        ...
        status = (
            ...
            if plan.status == GoalStatus.COMPLETED
