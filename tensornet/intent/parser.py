...
from .query import FieldQuery, Predicate
...
class EntityExtractor:
    ...
    # Operators
    operator_patterns: dict[str, list[str]] = field(
        default_factory=lambda: {
    ...
    # Comparison patterns
    comparison_patterns: dict[str, str] = field(
        default_factory=lambda: {
    ...
    def extract_region(self, text: str) -> str | None:
