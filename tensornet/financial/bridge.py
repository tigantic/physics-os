...
class LiquidityBridge:
    ...
    def stream_physics(
        ...
        if self.frame_count % 60 == 0:
            print(f"[BRIDGE] Frame {self.frame_count}: "
    ...
    def _send_breakout_alert(
        ...
        self._send_packet(packet)
        print(f"[ALERT] BREAKOUT: {breakout.direction.value} "
...
if __name__ == "__main__":
    ...
    parser.add_argument("--live", action="store_true", help="Run with live Coinbase data")
