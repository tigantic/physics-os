...
class ExportConfig:
    ...
    calibration_data: Optional[torch.Tensor] = None  # For INT8
...
class TensorRTExporter:
    ...
    def export(
        ...
        # Validate
        passed, max_error = validate_exported_model(
