...
class S3Fetcher:
    ...
    def __init__(
        self, max_concurrent: int = 10, timeout: int = 30, max_retries: int = 3
    ):
        """
        ...
        # Statistics
        self.stats = {"fetches": 0, "errors": 0, "bytes_downloaded": 0, "cache_hits": 0}
    ...
    async def fetch_tile(
        self, url: str, to_gpu: bool = True, device: str = "cuda:0"
    ) -> torch.Tensor | None:
        """
    ...
    async def fetch_tiles_batch(
        self, urls: list[str], to_gpu: bool = True, device: str = "cuda:0"
