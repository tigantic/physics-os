...
class Tokenizer:
    ...
    STOP_WORDS = {
        ...
        'the', 'to', 'was', 'were', 'will', 'with', 'this', 'can', 'you',
        'your', 'we', 'our', 'but', 'not', 'have', 'been', 'which', 'when',
        'there', 'their', 'what', 'so', 'if', 'out', 'up', 'into', 'just',
    }
    ...
    def search(
        ...
        for doc_id in candidates:
            ...
            if score > 0:
                ...
                preview, highlights = self._generate_preview(
    ...
    def index_pages(self, pages: List[Any]) -> int:
        ...
        for page in pages:
            indexed = self.index_document(
                ...
                url=page.path,
                doc_type=page.page_type.name if hasattr(page.page_type, 'name') else str(page.page_type),
