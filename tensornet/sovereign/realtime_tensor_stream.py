...
class RealtimeTensorStream:
    ...
    def __init__(
        ...
        print(f"RealtimeTensorStream initialized:")
        ...
        with self:
            while time.time() < end_time:
                ...
                if verbose and time.time() - self.last_fps_report >= 1.0:
                    ...
                    print(f"Frame {self.frame_count:6d} | "
                          f"FPS: {fps:6.2f} | "
    ...
    def stream_from_qtt(
        ...
        raise NotImplementedError(
            "QTT streaming not yet implemented. "
            "Use stream_synthetic() for testing."
        )
...
def test_realtime_stream(
    ...
    """
    print(f"=== Real-Time Tensor Stream Test ===")
