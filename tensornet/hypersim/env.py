...
class FluidEnv:
    ...
    def __init__(
        self,
        config: Optional[FluidEnvConfig] = None,
    ...
    def render(self) -> Optional[np.ndarray]:
        ...
        if self._render_cache is None:
            from tensornet.hypervisual import SliceEngine, apply_colormap, VIRIDIS
    ...
    def _action_to_forces(self, action: np.ndarray) -> List[Tuple[np.ndarray, np.ndarray]]:
