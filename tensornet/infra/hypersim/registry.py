...
Usage:
    from tensornet.infra.hypersim import make_env, register_env, list_envs
...
def make_env(
    ...
    **kwargs,
    ...
    if env_id not in _REGISTRY:
        ...
        raise ValueError(f"Environment {env_id} not found. " f"Available: {available}")
...
def register_with_gymnasium():
    ...
    for env_id, spec in _REGISTRY.items():
        ...
        try:
            gymnasium.register(
                id=gym_id,
                entry_point="tensornet.hypersim:make_env",
...
class TaskSpec:
    ...
    def __init__(
        ...
        initial_state_fn: Callable | None = None,
    ):
        self.name = name
