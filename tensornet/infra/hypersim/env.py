...
class FluidEnv:
    ...
    def render(self) -> np.ndarray | None:
        ...
        if self._render_cache is None:
            from tensornet.infra.hypervisual import VIRIDIS, SliceEngine, apply_colormap
    ...
    def _apply_forces(self, forces: list[tuple[np.ndarray, np.ndarray]]):
        ...
        from tensornet.infra.fieldops import Impulse
    ...
    def _step_physics(self):
        ...
        from tensornet.infra.fieldops import fluid_graph
