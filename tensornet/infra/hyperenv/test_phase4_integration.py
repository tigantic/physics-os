...
def test_hypersonic_env():
    ...
    from tensornet.infra.hyperenv.hypersonic_env import make_hypersonic_env
...
def test_training_script():
    ...
    from tensornet.infra.hyperenv.train_pilot import quick_test
...
def test_swarm_command():
    ...
    from tensornet.applied.intent.swarm_command import SwarmCommander, SwarmCommandType
...
def test_trajectory_tube():
    ...
    from tensornet.infra.hyperenv.hypersonic_env import TrajectoryTube
