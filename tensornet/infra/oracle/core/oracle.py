...
class ORACLE:
    ...
    def parser(self):
        ...
        if self._parser is None:
            from tensornet.infra.oracle.parsing import SolidityParser
    ...
    def intent_analyzer(self):
        ...
        if self._intent_analyzer is None:
            from tensornet.infra.oracle.semantic import IntentAnalyzer
    ...
    def explicit_extractor(self):
        ...
        if self._explicit_extractor is None:
            from tensornet.infra.oracle.assumptions import ExplicitExtractor
    ...
    def implicit_extractor(self):
        ...
        if self._implicit_extractor is None:
            from tensornet.infra.oracle.assumptions import ImplicitExtractor
    ...
    def economic_extractor(self):
        ...
        if self._economic_extractor is None:
            from tensornet.infra.oracle.assumptions import EconomicExtractor
    ...
    def scenario_generator(self):
        ...
        if self._scenario_generator is None:
            from tensornet.infra.oracle.scenarios import ScenarioGenerator
    ...
    def report_generator(self):
        ...
        if self._report_generator is None:
            from tensornet.infra.oracle.reporting import ReportGenerator
    ...
    def hunt(
        ...
        from tensornet.infra.oracle.challenger import AssumptionChallenger
        ...
        if fork_verify and self.eth_rpc:
            ...
            from tensornet.infra.oracle.execution.smart_exploiter import (
                SmartExploitVerifier,
                PatternDetector,
            )
            from tensornet.infra.oracle.execution import MainnetVerifier, AnvilFork, ForkConfig
                ...
                for vuln, profit in exploit_results:
                    if profit > 0:
                        ...
                        if profit_eth >= min_profit_eth:
                            ...
                            from tensornet.infra.oracle.core.types import AttackScenario, AttackStep
        ...
        if not fork_verify or not self.eth_rpc:
            ...
            from tensornet.infra.oracle.execution import ExploitVerifier
    ...
    def _fetch_source(self, address: str, chain: str) -> str:
        ...
        from tensornet.infra.oracle.execution import EtherscanClient
    ...
    def hunt_address(
        ...
        if fork_verify and scenarios:
            ...
            from tensornet.infra.oracle.execution import MainnetVerifier
