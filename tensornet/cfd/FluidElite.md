...
### ☐ 1.1 `tensornet/core/decompositions.py`
...
### ☐ 1.2 `tensornet/core/fast_ops.py`
...
### ☐ 2.1 `tensornet/optim/riemannian.py`
...
### ☐ 2.2 `tensornet/llm/fluid_elite.py`
...
```python
# WRONG (as provided):
from tensornet.llm.fluid_mpo import FluidLLM

# CORRECT:
from tensornet.llm.fluid_elite import FluidElite
```
...
### ☐ 1.1 Upgrade `tensornet/core/decompositions.py`
...
### ☐ 1.2 Create `tensornet/core/fast_ops.py`
...
### ☐ 1.3 Create `tensornet/core/cross.py`
...
### ☐ 2.1 Create `tensornet/optim/riemannian.py`
...
### ☐ 2.2 Create `tensornet/llm/fluid_elite.py`
...
### ☐ 3.2 Create `tensornet/llm/data.py`
...
## 4. `tensornet/optim/riemannian.py`
...
## 5. `tensornet/llm/fluid_elite.py`
...
from tensornet.core.cross import ProjectedActivation
from tensornet.core.fast_ops import vectorized_mpo_apply
...
# CORRECTED IMPORT (original had: from tensornet.llm.fluid_mpo import FluidLLM)
from tensornet.llm.fluid_elite import FluidElite
from tensornet.optim.riemannian import RiemannianAdam
from tensornet.core.mps import MPS
...
from tensornet.llm.fluid_elite import FluidElite
from tensornet.optim.riemannian import RiemannianAdam
from tensornet.llm.data import create_loader
from tensornet.core.mps import MPS
...
| Bug | Location | Fix |
|-----|----------|-----|
| Greek einsum chars | `tensornet/core/mpo.py:118` | `"αβγδ,ιγκ->ιαβκδ"` → `"abcd,ecf->eabfd"` |
