"""
Domain Pack VI — Solid-State / Condensed Matter
=================================================

Scaffold nodes (V0.1):
  PHY-VI.1   Band structure
  PHY-VI.2   Phonons
  PHY-VI.3   Superconductivity
  PHY-VI.4   Magnetism
  PHY-VI.5   Topological insulators
  PHY-VI.6   Strongly correlated systems
...
class SolidStateCondensedMatterPack(DomainPack):
    """Pack VI: Solid-State / Condensed Matter."""
    ...
    def pack_name(self) -> str:
        return "Solid-State / Condensed Matter"
...
get_registry().register_pack(SolidStateCondensedMatterPack())
