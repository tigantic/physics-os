"""
Domain Pack XX — Nonlinear Dynamics
=====================================

Scaffold nodes (V0.1):
  PHY-XX.1  Solitons
  PHY-XX.2  Pattern formation
  PHY-XX.3  Bifurcation
  PHY-XX.4  Synchronization
  PHY-XX.5  Complex networks
  PHY-XX.6  Stochastic dynamics
"""
