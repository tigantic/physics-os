"""
Domain Pack IV — Optics and Photonics
======================================

Scaffold nodes (V0.1):
  PHY-IV.1  Ray tracing
  PHY-IV.2  Wave optics
  PHY-IV.3  Fiber optics
  PHY-IV.4  Fourier optics
  PHY-IV.5  Nonlinear optics
  PHY-IV.6  Quantum optics
...
class OpticsPhotonicsPack(DomainPack):
...
get_registry().register_pack(OpticsPhotonicsPack())
