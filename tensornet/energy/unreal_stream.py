...
Run: python tensornet/energy/unreal_stream.py
"""
...
class UnrealBridge:
    ...
    def send_wake_cones(
        ...
        print(f"[BRIDGE] Sent {total_slices} wake cone slices for {len(farm.turbines)} turbines")
        return total_slices
    ...
    def send_comparison(
        ...
        self.send_packet(packet)
        print(f"[BRIDGE] Sent comparison: +{delta_power:.2f} MW (+{improvement_pct:.1f}%)")
