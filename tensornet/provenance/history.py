...
class Branch:
    ...
    # Tracking
    upstream: str | None = None  # Remote tracking branch
...
class HistoryGraph:
    ...
    def __init__(self, default_branch: str = "main"):
        ...
        self._head: str | None = None  # Detached HEAD if no branch
    ...
    def get_commit(self, ref: str) -> FieldCommit | None:
        """
    ...
    def log(
        ...
        while queue and count < n:
            ...
            parents = [
                self._commits[h] for h in current.parent_hashes if h in self._commits
            ]
    ...
    def common_ancestor(self, ref1: str, ref2: str) -> FieldCommit | None:
