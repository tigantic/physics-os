...
from .history import HistoryGraph, Branch
...
class ProvenanceStore:
    ...
    def __init__(
        ...
        self.config = config or StoreConfig(path=path or "./.hypertensor")
    ...
    def get_data(self, commit_hash: str) -> Optional[np.ndarray]:
        """
    ...
    def checkout(self, ref: str) -> Optional[np.ndarray]:
        """
