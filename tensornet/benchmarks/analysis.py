...
class OptimizationRecommendation:
    ...
    expected_memory_reduction: Optional[float] = None
...
class PerformanceAnalyzer:
    ...
    def analyze(
        ...
        analysis.compute_bound, analysis.memory_bound = self._classify_bound(profile_result)
        ...
        for op_type, op_profile in profile_result.operation_profiles.items():
            if op_profile.percentage > 30:  # Single op type >30%
                bottleneck = BottleneckAnalysis(
                    ...
                    severity=ImpactLevel.HIGH if op_profile.percentage > 50 else ImpactLevel.MEDIUM,
...
""",
        ...
        small_layers = [
            l for l in profile_result.layer_profiles
        ...
        # Memory optimization
        if hasattr(profile_result, 'peak_memory_bytes') and profile_result.peak_memory_bytes > 1e9:
            recommendations.append(OptimizationRecommendation(
