...
Wraps tensornet.coupled.thermo_mechanical.ThermoelasticSolver for STARK tracing.
...
class ThermoMechanicalTraceAdapter:
    ...
    def __init__(
        ...
        from tensornet.fluids.coupled.thermo_mechanical import ThermoelasticSolver
