...
class WakeTracker:
    ...
    def __init__(
        ...
        print(f"[RACING] Wake Tracker initialized")
...
def track_dirty_air(
    ...
    print(f"[RACING] Connecting to Telemetry Stream...")
