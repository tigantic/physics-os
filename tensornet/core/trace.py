...
# ═════════════════════════════════════════════════════════════════════════════
#
# These wrap the original tensornet.core functions to emit trace entries
...
def traced_svd_truncated(
    ...
    """
    from tensornet.core.decompositions import svd_truncated as _original_svd
...
def traced_qr_positive(A: Tensor) -> tuple[Tensor, Tensor]:
    ...
    from tensornet.core.decompositions import qr_positive as _original_qr
...
def install_trace_hooks() -> None:
    """
    Install trace hooks into tensornet.core modules.
    ...
    import tensornet.core.decompositions as decomp_mod
    import tensornet.core.mps as mps_mod
    import tensornet.core.mpo as mpo_mod
    ...
    _patched = True
    logger.info("Trace hooks installed into tensornet.core")
...
def uninstall_trace_hooks() -> None:
    ...
    _originals.clear()
    _patched = False
    logger.info("Trace hooks removed from tensornet.core")
