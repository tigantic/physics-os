...
class RequestQueue:
    ...
    ) -> tuple[torch.Tensor, InferencePriority, str]:
...
class ResultCache:
    ...
    def get(self, tensor: torch.Tensor) -> InferenceResult | None:
...
class InferenceEngine:
    ...
    def __init__(
        ...
        self._result_cache = (
            ResultCache(self.config.cache_size) if self.config.enable_caching else None
        )
