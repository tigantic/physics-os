...
Wraps tensornet.geophysics.glaciology.ShallowIceApproximation for STARK tracing.
...
class GlaciologyTraceAdapter:
    ...
    def __init__(
        ...
        from tensornet.astro.geophysics.glaciology import ShallowIceApproximation
