...
Wraps tensornet.geophysics.mantle_convection.MantleConvection2D for tracing.
...
class MantleConvectionTraceAdapter:
    ...
    def __init__(
        ...
        from tensornet.astro.geophysics.mantle_convection import MantleConvection2D
