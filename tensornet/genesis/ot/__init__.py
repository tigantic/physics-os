...
from tensornet.genesis.ot.sinkhorn_qtt import QTTSinkhorn, SinkhornResult, sinkhorn_distance

# Distribution representations
from tensornet.genesis.ot.distributions import QTTDistribution

# Cost matrix representations
from tensornet.genesis.ot.cost_matrices import (
    QTTMatrix,
    euclidean_cost_mpo,
    gaussian_kernel_mpo,
    toeplitz_cost_mpo,
...
from tensornet.genesis.ot.wasserstein import wasserstein_distance, wasserstein_barycenter

# Transport plan extraction
from tensornet.genesis.ot.transport_plan import QTTTransportPlan, transport_plan, monge_map

# Barycenter computation
from tensornet.genesis.ot.barycenters import (
    barycenter,
    BarycenterResult,
    interpolate,
    geodesic,
