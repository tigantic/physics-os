...
from tensornet.gateway.modular_grid import HUDCorner, ModularGrid
from tensornet.gateway.onion_renderer import LayerType, OnionRenderer

# Phase 4: Gateway UI/UX
from tensornet.gateway.photonic_discipline import PhotonicPalette
