...
class ModularGrid:
    ...
    def _compute_zones(self):
        ...
        self.kinetic_zone = Rect(
            x=0, y=0, width=kinetic_width, height=self.viewport_height
        )
        ...
        self.analytical_zone = Rect(
            x=analytical_x, y=0, width=analytical_width, height=self.viewport_height
        )
    ...
    def _create_huds(self):
        ...
        self.huds[HUDCorner.TOP_LEFT] = Rect(
            x=margin, y=margin, width=hud_width, height=hud_height
        )
