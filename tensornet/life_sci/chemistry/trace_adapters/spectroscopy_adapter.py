...
Wraps tensornet.chemistry.spectroscopy.VibrationalSpectroscopy for STARK tracing.
...
class SpectroscopyTraceAdapter:
    ...
    def __init__(self) -> None:
        from tensornet.life_sci.chemistry.spectroscopy import VibrationalSpectroscopy
