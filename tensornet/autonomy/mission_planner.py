...
class Mission:
    ...
    def progress(self) -> float:
        ...
        completed = sum(
            ...
            if p.status == MissionStatus.COMPLETED
        )
    ...
    def get_next_phase(self) -> Optional[MissionPhase]:
...
class MissionPlanner:
    ...
    ) -> Tuple[bool, Optional[MissionPhase]]:
...
def execute_mission(
    mission: Mission,
    phase_executor: Optional[Callable[[MissionPhase], Any]] = None,
) -> MissionResult:
    """Execute a mission.
