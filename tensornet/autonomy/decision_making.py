...
class ActionSpace:
    ...
    def filter_by_constraints(self) -> list[ActionOption]:
        ...
        for option in self.options:
            if (
                option.risk_level <= max_risk
                and option.cost <= max_cost
                and option.time_estimate <= max_time
            ):
                valid.append(option)
...
class Decision:
    ...
    selected_action: ActionOption | None = None
...
class DecisionMaker:
    ...
    def __init__(
        self,
        config: DecisionMakerConfig | None = None,
    ) -> None:
        ...
        self.state: StateEstimate | None = None
    ...
    def get_decision_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "decision_types": [
                d.decision_type.name for d in self.decision_history[-5:]
            ],
        }
