...
class GuideBuilder:
    ...
    def __init__(self, title: str):
        ...
        self._current_section: Optional[GuideSection] = None
...
def create_getting_started() -> Tutorial:
    ...
    builder.add_section("Installation", """
...
""", description="Installing from source:")
    ...
    # Quick start section
    builder.add_section("Quick Start", """
...
""")
    ...
    builder.add_subsection("Matrix Product States (MPS)", """
...
""")
    ...
    builder.add_subsection("Matrix Product Operators (MPO)", """
...
""")
    ...
    builder.add_subsection("DMRG Algorithm", """
...
""")
    ...
    # CFD section
    builder.add_section("Your First CFD Simulation", """
...
""",
    ...
    # Next steps section
    builder.add_section("Next Steps", """
...
""")
    ...
    builder.add_section("1D Euler Equations", """
...
""",
    ...
    # 2D Euler section
    builder.add_section("2D Euler Equations (Hypersonic Wedge)", """
...
""",
    ...
    builder.add_section("Navier-Stokes with Viscous Effects", """
...
""",
    ...
    builder.add_section("QTT Compression", """
...
def create_tensor_network_primer() -> Tutorial:
    ...
    # What are tensors
    builder.add_section("What are Tensors?", """
...
""",
    ...
    # Tensor contractions
    builder.add_section("Tensor Contractions", """
...
""",
    ...
    # MPS section
    builder.add_section("Matrix Product States (MPS)", """
...
""",
    ...
    # DMRG section
    builder.add_section("DMRG Algorithm", """
...
""",
    ...
    # Area law section  
    builder.add_section("The Area Law", """
...
def create_deployment_guide() -> Tutorial:
    ...
    # Export section
    builder.add_section("Exporting to ONNX", """
...
""",
    ...
    # TensorRT section
    builder.add_section("Optimizing with TensorRT", """
...
""",
    ...
    # Jetson section
    builder.add_section("Deploying to Jetson", """
...
""",
    ...
    # Real-time section
    builder.add_section("Meeting Real-Time Requirements", """
