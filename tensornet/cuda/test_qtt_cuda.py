...
def test_cpu_operations():
    ...
    from tensornet.cfd.pure_qtt_ops import QTTState, qtt_add, qtt_hadamard
...
def test_cuda_availability():
    ...
    try:
        from tensornet.cuda.qtt_native_ops import is_cuda_available, _try_load_cuda
...
def test_cuda_performance():
    ...
    try:
        from tensornet.cuda.qtt_native_ops import benchmark_cuda_vs_cpu
