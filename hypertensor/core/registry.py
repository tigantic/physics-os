...
Maps public domain identifiers to internal ``tensornet.vm`` compiler
...
DOMAINS: dict[str, DomainSpec] = {
    "burgers": DomainSpec(
        ...
        _module="tensornet.engine.vm.compilers.navier_stokes",
    ...
    "maxwell": DomainSpec(
        ...
        _module="tensornet.engine.vm.compilers.maxwell",
    ...
    "maxwell_3d": DomainSpec(
        ...
        _module="tensornet.engine.vm.compilers.maxwell_3d",
    ...
    "schrodinger": DomainSpec(
        ...
        _module="tensornet.engine.vm.compilers.schrodinger",
    ...
    "advection_diffusion": DomainSpec(
        ...
        _module="tensornet.engine.vm.compilers.diffusion",
    ...
    "vlasov_poisson": DomainSpec(
        ...
        _module="tensornet.engine.vm.compilers.vlasov_poisson",
    ...
    "navier_stokes_2d": DomainSpec(
        ...
        _module="tensornet.engine.vm.compilers.navier_stokes_2d",
