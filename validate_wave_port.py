...
def run_validation() -> int:
    ...
    from tensornet.vm.compilers.maxwell_antenna_3d import (
        MaxwellAntenna3DCompiler,
        DipoleGeometry,
        WavePort,
    )
    from tensornet.vm.gpu_runtime import GPURuntime, GPURankGovernor
    from tensornet.vm.postprocessing.s_parameters import SParameterExtractor
    from tensornet.vm.postprocessing.far_field import FarFieldExtractor
