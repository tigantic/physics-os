...
{
    /// <summary>
    /// Field renderer for visualizing Ontic fields.
    /// Supports slices, isosurfaces, and volume rendering.
    /// </summary>
    [RequireComponent(typeof(OnticField))]
    [AddComponentMenu("Ontic/Field Renderer")]
    public class OnticFieldRenderer : MonoBehaviour
    {
        // =========================================================================
        // CONFIGURATION
        // =========================================================================
        ...
        private void SetupSliceVisualization()
        {
            ...
            else
            {
                ...
                if (shader == null)
                {
                    Debug.LogError("OnticFieldRenderer: 'Unlit/Texture' shader not found. Ensure it's included in Always Included Shaders.");
