...
namespace Tigantic.Ontic.Editor
{
    /// <summary>
    /// Custom inspector for OnticField.
    /// </summary>
    [CustomEditor(typeof(OnticField))]
    public class OnticFieldEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Ontic Field", EditorStyles.boldLabel);
            EditorGUILayout.Space();
