...
### Rust (Prover)
- [groth16_output.rs](fluidelite-zk/src/groth16_output.rs) - Groth16 serialization with REAL curve points
- [qtt_native_msm.rs](fluidelite-zk/src/qtt_native_msm.rs) - GPU MSM for QTT commitment
- [semaphore/prover.rs](fluidelite-zk/src/semaphore/prover.rs) - Zero-Expansion Semaphore prover
- [bin/worldcoin_production.rs](fluidelite-zk/src/bin/worldcoin_production.rs) - Production demo

### Solidity (Verifier)
- [Groth16Verifier.sol](fluidelite-zk/contracts/Groth16Verifier.sol) - Standard ecPairing verifier
- [WorldcoinZeroExpansion.sol](fluidelite-zk/contracts/WorldcoinZeroExpansion.sol) - Worldcoin integration
