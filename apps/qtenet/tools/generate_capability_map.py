...
def cap_defs() -> list[Capability]:
    ...
    return [
        ...
        Capability(
            ...
            include=[R(r"decomp|truncate|round|svd"), R(r"^ontic/core/"), R(r"^The_Compressor/")],
        ...
        Capability(
            ...
            include=[R(r"^ontic/cfd/"), R(r"shift|roll|hadamard|walsh|spectral")],
        ...
        Capability(
            ...
            include=[R(r"^ontic/cfd/"), R(r"laplac|grad|div|advec|diffus|poisson")],
        ...
        Capability(
            ...
            include=[R(r"^ontic/genesis/tropical/")],
        ...
        Capability(
            ...
            include=[R(r"^ontic/genesis/rkhs/")],
        ...
        Capability(
            ...
            include=[R(r"^ontic/genesis/topology/")],
        ...
        Capability(
            ...
            include=[R(r"^ontic/cuda/"), R(r"^ontic/gpu/"), R(r"triton"), R(r"kernel")],
