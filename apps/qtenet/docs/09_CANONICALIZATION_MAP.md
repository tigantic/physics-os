...
- `apps/sdk_legacy/qtt-sdk/src/qtt_sdk/core.py` — function L230 (cat=sdk)
...
**Canonical:** `tests/experiments/benchmarks/benchmarks/qtt_native_benchmark.py` — `function` at L74 (score 20)

**Alternates:**

- `tests/experiments/benchmarks/benchmarks/qtt_native_benchmark.py` — function L74 (cat=qtt-misc)
...
- `tools/tools/scripts/check_import_cycles.py` — function L21 (cat=other)
...
**Canonical:** `apps/sdk_legacy/qtt-sdk/src/qtt_sdk/core.py` — `function` at L266 (score 106)

**Alternates:**

- `apps/sdk_legacy/qtt-sdk/src/qtt_sdk/core.py` — function L266 (cat=sdk)
