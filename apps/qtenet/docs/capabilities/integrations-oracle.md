...
- `ontic/exploit/evm_oracle.py` (cat=other, score=50)
- `ontic/exploit/hypergrid.py` (cat=other, score=50)
- `ontic/exploit/invariants.py` (cat=other, score=50)
- `ontic/exploit/morpho_blue_hunt.py` (cat=other, score=50)
- `ontic/exploit/state_encoder.py` (cat=other, score=50)
- `ontic/exploit/toy_contracts.py` (cat=other, score=50)
