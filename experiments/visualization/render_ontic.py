#!/usr/bin/env python3
"""
Ontic Scientific Visualization — Blender Cycles Pipeline
================================================================
...
Usage:
    blender --background --python visualization/render_ontic.py
...
def main() -> None:
    ...
    print("\n" + "=" * 72)
    print("  ONTIC_ENGINE — Blender Cycles Scientific Visualization")
