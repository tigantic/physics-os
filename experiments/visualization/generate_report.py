...
def fig_title_page(data: dict[str, Any]) -> plt.Figure:
    ...
    # Title
    ax.text(0.5, 0.78, "physics-os", transform=ax.transAxes,
    ...
    ax.text(0.5, 0.04, "Generated by physics-os Visualization Pipeline",
            transform=ax.transAxes, fontsize=FONT_SIZES["watermark"],
...
def fig_summary_dashboard(data: dict[str, Any]) -> plt.Figure:
    ...
    fig.suptitle("physics-os — Simulation Results Summary",
