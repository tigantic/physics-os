...
**Target:** `hypertensor-ui/`

```bash
# Initialize from creme-stack
cp -r HVAC_CFD/Review/creme-stack hypertensor-ui
cd hypertensor-ui

# Update package identity
npm pkg set name="hypertensor-ui"
...
1. **Initialize project:** `cp -r creme-stack hypertensor-ui`
