...
Ontic UI is a modern, GPU-accelerated computational fluid dynamics (CFD) simulation interface built with Next.js 14 and React 18. It provides real-time monitoring, visualization, and control of HyperFOAM simulations through an intuitive dashboard.
