  ...
  const actions = [
    {
      ...
      icon: Play,
      description: 'Start a CFD simulation',
    },
    {
      label: 'View Meshes',
      href: '/meshes',
      icon: Box,
      description: 'Manage & import meshes',
    },
    {
      label: 'View Results',
      href: '/results',
      icon: BarChart3,
      description: 'Analyze completed runs',
    },
    {
      label: 'System Status',
      href: '/settings',
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <DashboardShell>
          <div className="space-y-6">
            <PageHeader
              title="Dashboard"
              description="Monitor your HyperGrid simulations and system status"
            />
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {/* Active Simulations - Takes 2 columns */}
