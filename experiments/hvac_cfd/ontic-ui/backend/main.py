...
FastAPI backend providing REST endpoints for the Ontic Engine UI.
Matches the OpenAPI schema defined in ONTIC_UI_SPEC.md.
...
LOAD_DEMO_DATA = os.environ.get("ONTIC_ENGINE_DEMO_DATA", "false").lower() == "true"
...
app = FastAPI(
    ...
    description="REST API for Ontic CFD simulations",
    version="1.0.0",
    lifespan=lifespan,
)
