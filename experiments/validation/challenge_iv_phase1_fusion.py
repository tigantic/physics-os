...
from tensornet.qtt.eigensolvers import tt_inner, tt_norm, tt_axpy, tt_scale, tt_add, tt_lanczos, TTEigResult
...
def generate_report(result: PipelineResult) -> Path:
    ...
    lines += [
        ...
        "",
        "---",
        f"*Generated by HyperTensor-VM Challenge IV Phase 1 pipeline*",
    ]
