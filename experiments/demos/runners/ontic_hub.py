...
The primary interface for interacting with The Ontic Engine manifolds.
...
Usage:
    python demos/ontic_hub.py
    
    Or with a specific field:
    python demos/ontic_hub.py --load path/to/field.htf
"""
...
class OnticHub(QMainWindow):
    """
    Ontic Hub - Primary interface for manifold interaction.
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("ONTIC_ENGINE HUB | 4D FORENSIC SUBSTRATE")
    ...
    def init_ui(self):
        ...
        self.status_bar.showMessage("Ontic Hub v1.0 | No field loaded")
...
╚══════════════════════════════════════════════════════════════════════╝
    ...
    q_app.setApplicationName("Ontic Hub")
