...
\author{%
HyperTensor-VM Collaboration\\
\texttt{hypertensor-vm@sovereign.compute}\\[1em]
...
VERIFICATION: VALID
SIGNER: HyperTensor-VM Sovereign Compute
\end{verbatim}
\end{tcolorbox}
...
This work was performed on the HyperTensor-VM sovereign compute infrastructure. All computations are cryptographically attested and reproducible.
...
# Clone repository
git clone https://github.com/HyperTensor-VM/yangmills-qtt.git
cd yangmills-qtt
...
KEY_ID: HYPERTENSOR-VM-SOVEREIGN-2026
