...
- `tensornet/exploit/state_encoder.py` → **core** (score=130, lang=py)
- `tensornet/zk/fluidelite_circuit_analyzer.py` → **tci** (score=125, lang=py)
- `tensornet/docs/user_guides.py` → **core** (score=120, lang=py)
- `yangmills/__init__.py` → **core** (score=120, lang=py)
- `crates/hyper_core/src/lib.rs` → **core** (score=118, lang=rs)
- `compress_crypto_data.py` → **core** (score=105, lang=py)
- `proofs/proof_millennium.py` → **core** (score=105, lang=py)
- `tensornet/visualization/tensor_slicer.py` → **gpu** (score=105, lang=py)
- `crates/tci_core/src/lib.rs` → **tci** (score=98, lang=rs)
- `fluidelite_ingest.py` → **core** (score=90, lang=py)
- `tensornet/types/genesis_integration.py` → **core** (score=90, lang=py)
- `fluidelite-zk/src/bin/fluid_block.rs` → **core** (score=88, lang=rs)
- `tensornet/benchmarks/profile_bottlenecks.py` → **cfd** (score=80, lang=py)
- `tensornet/types/__init__.py` → **core** (score=80, lang=py)
- `fluidelite-zk/src/lib.rs` → **core** (score=78, lang=rs)
- `tensornet/exploit/__init__.py` → **tci** (score=75, lang=py)
- `tensornet/exploit/bounty_api.py` → **tci** (score=75, lang=py)
- `tensornet/exploit/constants.py` → **tci** (score=75, lang=py)
- `tensornet/exploit/euler_v2_hunt.py` → **tci** (score=75, lang=py)
- `tensornet/exploit/exploit_hunter.py` → **tci** (score=75, lang=py)
- `tensornet/exploit/morpho_blue_hunt.py` → **tci** (score=75, lang=py)
- `tensornet/exploit/tx_space.py` → **tci** (score=75, lang=py)
- `tensornet/substrate/morton_ops.py` → **core** (score=75, lang=py)
...
- `fluidelite-zk/src/bin/fluid_s3_native.rs` → **core** (score=73, lang=rs)
...
- `scripts/check_import_cycles.py` → **core** (score=65, lang=py)
- `scripts/full_reproduce.py` → **core** (score=65, lang=py)
- `scripts/setup/hypertensor_core.py` → **core** (score=65, lang=py)
- `tensornet/__init__.py` → **core** (score=65, lang=py)
- `tensornet/gateway/orbital_command.py` → **core** (score=65, lang=py)
- `tensornet/neural/genesis_optimizer.py` → **core** (score=65, lang=py)
- `tensornet/sovereign/heatmap_generator.py` → **gpu** (score=65, lang=py)
- `tensornet/substrate/field.py` → **core** (score=65, lang=py)
...
- `proof_engine/Certified.py` (score=40, lang=py)
- `proof_engine/Certified_ARB.py` (score=40, lang=py)
- `proof_engine/__init__.py` (score=40, lang=py)
- `proof_engine/certificate.py` (score=40, lang=py)
- `proof_engine/constructive_qft.py` (score=40, lang=py)
- `proof_engine/lean_export.py` (score=40, lang=py)
...
- `scripts/generate_api_docs.py` (score=40, lang=py)
- `scripts/generate_pipeline_diagram.py` (score=40, lang=py)
- `scripts/setup/realtime_renderer.py` (score=40, lang=py)
- `scripts/testing/test_implicit_concept.py` (score=40, lang=py)
- `scripts/testing/test_phase4_integration.py` (score=40, lang=py)
- `scripts/testing/test_phase4_validation.py` (score=40, lang=py)
- `sovereign_daemon.py` (score=40, lang=py)
- `sovereign_genesis_gauntlet.py` (score=40, lang=py)
- `tensornet/discovery/__main__.py` (score=40, lang=py)
- `tensornet/discovery/api/gpu.py` (score=40, lang=py)
- `tensornet/discovery/api/server.py` (score=40, lang=py)
- `tensornet/discovery/engine_v2.py` (score=40, lang=py)
- `tensornet/discovery/ingest/markets.py` (score=40, lang=py)
- `tensornet/discovery/ingest/molecular.py` (score=40, lang=py)
- `tensornet/discovery/ingest/plasma.py` (score=40, lang=py)
- `tensornet/discovery/pipelines/markets_pipeline.py` (score=40, lang=py)
- `tensornet/discovery/pipelines/molecular_pipeline.py` (score=40, lang=py)
- `tensornet/discovery/primitives/__init__.py` (score=40, lang=py)
- `tensornet/discovery/primitives/geometric_algebra.py` (score=40, lang=py)
