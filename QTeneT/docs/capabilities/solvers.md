...
- `tensornet/cfd/flux_batch.py` (cat=cfd, lang=py, score=135)
- `tensornet/cfd/kelvin_helmholtz.py` (cat=cfd, lang=py, score=135)
...
- `tensornet/cfd/singularity_hunter.py` (cat=cfd, score=135)
...
- `tensornet/cfd/thermal_qtt.py` (cat=cfd, score=135)
...
- `tensornet/cfd/FluidElite.md` (cat=cfd, score=125)
