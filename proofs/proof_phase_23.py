...
# Results storage
RESULTS = {"phase": "23", "title": "Infrastructure Hardening (TMR)", "proofs": []}
...
def proof_23_1_tmr_bit_flip():
    ...
    from ontic.infra.deployment.rad_hard import (MajorityVoter, TMRConfig,
                                               TMRExecutor)
...
def proof_23_2_tmr_multiple_flips():
    ...
    from ontic.infra.deployment.rad_hard import MajorityVoter
...
def proof_23_3_conservation_watchdog():
    ...
    from ontic.infra.deployment.rad_hard import ConservationWatchdog
    ...
    record_proof(
        "Conservation Watchdog Detection",
        passed,
        {
...
def proof_23_4_checkpoint_rollback():
    ...
    from ontic.infra.deployment.rad_hard import (CheckpointManager,
...
def proof_23_5_tmr_executor():
    ...
    from ontic.infra.deployment.rad_hard import TMRConfig, TMRExecutor
    ...
    multi_correct = torch.allclose(out1, x * 2) and torch.allclose(out2, x**2)

    passed = correct and stats_ok and multi_correct

    record_proof(
        "TMR Executor Integration",
        passed,
        {
