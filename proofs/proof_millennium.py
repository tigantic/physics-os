...
def print_banner():
    ...
    print("█" * 72)
    print("█" + " " * 70 + "█")
    print("█" + "  MILLENNIUM PRIZE PROOF ATTEMPT: NAVIER-STOKES BLOW-UP".center(70) + "█")
    print("█" + " " * 70 + "█")
    print("█" + "  Computer-Assisted Proof via Newton-Kantorovich Theorem".center(70) + "█")
    print("█" + " " * 70 + "█")
    print("█" * 72)
    print("=" * 72)
    print()
...
def phase_2_find_candidate(
    ...
    print(f"  Objective improvement: {result.objective_history[-1] / result.objective_history[0]:.2f}x")
    print("-" * 72)
...
def phase_4_bkm_analysis(
    ...
    enstrophy_growth = enstrophy_history[-1] / enstrophy_history[0] if enstrophy_history[0] > 0 else 1.0
...
def run_millennium_proof(
    ...
    if bounds.status == VerificationStatus.PROOF_SUCCESS:
        ...
        print(f"  A self-similar singularity EXISTS within error bound {result.error_bound:.6e}")
        print()
