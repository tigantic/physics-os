...
all The Ontic Engine verification layers.
...
<html>
<head>
<title>Ontic Proof Dashboard</title>
<style>
...
<footer style="margin-top:2rem;color:#666;font-size:0.8rem;">Generated by Ontic Proof Engine</footer>
</body>
</html>"""
