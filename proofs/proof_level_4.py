...
def compute_energy(u: torch.Tensor, v: torch.Tensor, w: torch.Tensor, 
...
def compute_dissipation(u: torch.Tensor, v: torch.Tensor, w: torch.Tensor,
                        dx: float, dy: float, dz: float) -> float:
    """
    ...
    grad_u_sq = (dudx**2 + dudy**2 + dudz**2 + 
