...
def test_discovery_request():
    ...
    from tensornet.discovery.api.models import DiscoveryRequest, DomainType
...
def test_discovery_response():
    ...
    from tensornet.discovery.api.models import (
...
def test_gpu_status():
    ...
    from tensornet.discovery.api.models import GPUStatus, GPUDevice
...
def test_streaming_request():
    ...
    from tensornet.discovery.api.models import StreamingRequest, SeverityLevel
...
def test_gpu_availability():
    ...
    from tensornet.discovery.api.gpu import gpu_available, get_gpu_info
...
def test_gpu_backend_cpu():
    ...
    from tensornet.discovery.api.gpu import GPUBackend, AcceleratorConfig, AcceleratorType
    import numpy as np
...
def test_gpu_backend_fft():
    """Test GPUBackend FFT."""
    from tensornet.discovery.api.gpu import GPUBackend
    import numpy as np
...
def test_icicle_ntt():
    ...
    from tensornet.discovery.api.gpu import IcicleAccelerator
    import numpy as np
...
def test_distributed_config():
    ...
    from tensornet.discovery.api.distributed import DistributedConfig
...
def test_worker_node():
    """Test WorkerNode."""
    from tensornet.discovery.api.distributed import WorkerNode, DistributedTask
...
def test_distributed_coordinator():
    ...
    from tensornet.discovery.api.distributed import DistributedCoordinator
...
def test_server_config():
    """Test ServerConfig."""
    from tensornet.discovery.api.server import ServerConfig
...
def test_server_stats():
    """Test ServerStats."""
    from tensornet.discovery.api.server import ServerStats
...
def test_api_server_creation():
    ...
    from tensornet.discovery.api.server import DiscoveryAPIServer, ServerConfig, FASTAPI_AVAILABLE
...
def test_create_app():
    ...
    from tensornet.discovery.api.server import create_app, ServerConfig, FASTAPI_AVAILABLE
...
def test_attestation_hash():
    ...
    from tensornet.discovery.api.models import DiscoveryResponse, DomainType
    import hashlib
    import json
