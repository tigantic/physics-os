...
def test_tt_step_no_dense_proof_mode():
    ...
    try:
        ...
        return {"test": "tt_step_no_dense_proof_mode", "error": str(e), "passed": False}
...
def test_guard_catches_forced_violation():
    ...
    try:
        guard2 = DenseMaterializationGuard(
            hard_threshold=1000, soft_threshold=100, forbid=True, N=N, d=d
        )
    ...
    all_passed = (
        violation_caught and stack_caught and clone_caught and diagnostic_allowed
    )
...
def test_tt_solve_no_dense():
    ...
    try:
        ...
        return {"test": "tt_solve_no_dense", "error": str(e), "passed": False}
...
def test_mps_operations_no_dense():
    ...
    try:
        ...
        return {"test": "mps_operations_no_dense", "error": str(e), "passed": False}
...
def run_all_proofs():
    ...
    tests = [
        (
            "🔒 KILLER: Guard Catches Forced Violation",
            test_guard_catches_forced_violation,
        ),
    ...
    for name, test_fn in tests:
        ...
        try:
            ...
            if result.get("test") == "guard_catches_forced_violation":
                ...
                print(
                    f"  diagnostic_allowed: {result.get('diagnostic_allowed', 'N/A')}"
                )
