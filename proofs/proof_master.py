...
def run_phase(phase_num: int) -> dict:
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location(f"proof_phase_{phase_num}", script)
        ...
        return {'phase': phase_num, 'status': 'ERROR', 'passed': 0, 'total': 0, 'error': str(e)}
...
def main():
    ...
    if phase_1de.exists():
        ...
        try:
            ...
            results.append({'phase': '1D/1E', 'status': 'ERROR', 'passed': 0, 'total': 4})
