...
def test_statmech_equilibrium_mc_solve():
    from tensornet.statmech.trace_adapters.equilibrium_mc_adapter import EquilibriumMCTraceAdapter
...
def test_statmech_monte_carlo_general_solve():
    from tensornet.statmech.trace_adapters.monte_carlo_general_adapter import MonteCarloGeneralTraceAdapter
...
def test_bio_protein_structure_solve():
    from tensornet.biophysics.trace_adapters.protein_structure_adapter import ProteinStructureTraceAdapter
...
def test_bio_drug_design_solve():
    from tensornet.biophysics.trace_adapters.drug_design_adapter import DrugDesignTraceAdapter
...
def test_bio_membrane_solve():
    from tensornet.biophysics.trace_adapters.membrane_adapter import MembraneTraceAdapter
...
def test_bio_nucleic_acids_solve():
    from tensornet.biophysics.trace_adapters.nucleic_acids_adapter import NucleicAcidsTraceAdapter
...
def test_bio_systems_biology_solve():
    from tensornet.biophysics.trace_adapters.systems_biology_adapter import SystemsBiologyTraceAdapter
...
def test_bio_neuroscience_solve():
    from tensornet.biophysics.trace_adapters.neuroscience_adapter import NeuroscienceTraceAdapter
...
def test_comp_optimization_solve():
    from tensornet.computational_methods.trace_adapters.optimization_adapter import OptimizationTraceAdapter
...
def test_comp_inverse_problems_solve():
    from tensornet.computational_methods.trace_adapters.inverse_problems_adapter import InverseProblemsTraceAdapter
...
def test_comp_ml_physics_solve():
    from tensornet.ml_physics.trace_adapters.ml_physics_adapter import MLPhysicsTraceAdapter
...
def test_comp_mesh_generation_solve():
    from tensornet.computational_methods.trace_adapters.mesh_generation_adapter import MeshGenerationTraceAdapter
...
def test_comp_large_scale_linalg_solve():
    from tensornet.computational_methods.trace_adapters.large_scale_linalg_adapter import LargeScaleLinAlgTraceAdapter
...
def test_comp_hpc_solve():
    from tensornet.computational_methods.trace_adapters.hpc_adapter import HPCTraceAdapter
...
def test_special_relativity_solve():
    from tensornet.relativity.trace_adapters.special_relativity_adapter import SpecialRelativityTraceAdapter
...
def test_numerical_gr_solve():
    from tensornet.relativity.trace_adapters.numerical_gr_adapter import NumericalGRTraceAdapter
...
def test_astrodynamics_solve():
    from tensornet.special_applied.trace_adapters.astrodynamics_adapter import AstrodynamicsTraceAdapter
...
def test_robotics_solve():
    from tensornet.robotics_physics.trace_adapters.robotics_adapter import RoboticsTraceAdapter
...
def test_acoustics_solve():
    from tensornet.acoustics.trace_adapters.acoustics_adapter import AcousticsTraceAdapter
...
def test_biomedical_solve():
    from tensornet.biomedical.trace_adapters.biomedical_adapter import BiomedicalTraceAdapter
...
def test_environmental_solve():
    from tensornet.environmental.trace_adapters.environmental_adapter import EnvironmentalTraceAdapter
...
def test_energy_systems_solve():
    from tensornet.energy.trace_adapters.energy_systems_adapter import EnergySystemsTraceAdapter
...
def test_manufacturing_solve():
    from tensornet.manufacturing.trace_adapters.manufacturing_adapter import ManufacturingTraceAdapter
...
def test_semiconductor_solve():
    from tensornet.semiconductor.trace_adapters.semiconductor_adapter import SemiconductorTraceAdapter
