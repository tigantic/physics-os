...
Generates TPC certificates for all 40 Tier 2B domains.
    ...
    python scripts/tpc/generate_phase7.py --domain all
    python scripts/tpc/generate_phase7.py --domain newtonian_dynamics
    python scripts/tpc/generate_phase7.py --domain stellar_structure --output my_cert.tpc
