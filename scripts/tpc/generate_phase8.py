...
(Iterative / Eigenvalue):
    ...
    python scripts/tpc/generate_phase8.py --domain all
    python scripts/tpc/generate_phase8.py --domain tise
    python scripts/tpc/generate_phase8.py --domain dft --output my_cert.tpc
...
def _run_tise() -> dict[str, Any]:
    from tensornet.quantum_mechanics.trace_adapters.tise_adapter import TISETraceAdapter
...
def _run_tdse() -> dict[str, Any]:
    from tensornet.quantum_mechanics.trace_adapters.tdse_adapter import TDSETraceAdapter
...
def _run_scattering() -> dict[str, Any]:
    from tensornet.qm.trace_adapters.scattering_adapter import ScatteringTraceAdapter
...
def _run_semiclassical() -> dict[str, Any]:
    from tensornet.qm.trace_adapters.semiclassical_adapter import SemiclassicalTraceAdapter
...
def _run_path_integrals() -> dict[str, Any]:
    from tensornet.quantum_mechanics.trace_adapters.path_integrals_adapter import PathIntegralsTraceAdapter
...
def _run_quantum_spin() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.quantum_spin_adapter import QuantumSpinTraceAdapter
...
def _run_strongly_correlated() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.strongly_correlated_adapter import StronglyCorrelatedTraceAdapter
...
def _run_topological() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.topological_adapter import TopologicalTraceAdapter
...
def _run_mbl() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.mbl_adapter import MBLTraceAdapter
...
def _run_lattice_gauge() -> dict[str, Any]:
    from tensornet.qft.trace_adapters.lattice_gauge_adapter import LatticeGaugeTraceAdapter
...
def _run_open_quantum() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.open_quantum_adapter import OpenQuantumTraceAdapter
...
def _run_nonequilibrium_qm() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.nonequilibrium_qm_adapter import NonEquilibriumQMTraceAdapter
...
def _run_kondo() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.kondo_adapter import KondoTraceAdapter
...
def _run_bosonic() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.bosonic_adapter import BosonicTraceAdapter
...
def _run_fermionic() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.fermionic_adapter import FermionicTraceAdapter
...
def _run_nuclear_many_body() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.nuclear_many_body_adapter import NuclearManyBodyTraceAdapter
...
def _run_ultracold() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.ultracold_adapter import UltracoldTraceAdapter
...
def _run_dft() -> dict[str, Any]:
    from tensornet.electronic_structure.trace_adapters.dft_adapter import DFTTraceAdapter
...
def _run_beyond_dft() -> dict[str, Any]:
    from tensornet.electronic_structure.trace_adapters.beyond_dft_adapter import BeyondDFTTraceAdapter
...
def _run_tight_binding() -> dict[str, Any]:
    from tensornet.electronic_structure.trace_adapters.tight_binding_adapter import TightBindingTraceAdapter
...
def _run_excited_states() -> dict[str, Any]:
    from tensornet.electronic_structure.trace_adapters.excited_states_adapter import ExcitedStatesTraceAdapter
...
def _run_response() -> dict[str, Any]:
    from tensornet.electronic_structure.trace_adapters.response_adapter import ResponseTraceAdapter
...
def _run_relativistic() -> dict[str, Any]:
    from tensornet.electronic_structure.trace_adapters.relativistic_adapter import RelativisticTraceAdapter
...
def _run_embedding() -> dict[str, Any]:
    from tensornet.electronic_structure.trace_adapters.embedding_adapter import EmbeddingTraceAdapter
...
def _run_phonons() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.phonons_adapter import PhononsTraceAdapter
...
def _run_band_structure() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.band_structure_adapter import BandStructureTraceAdapter
...
def _run_classical_magnetism() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.classical_magnetism_adapter import ClassicalMagnetismTraceAdapter
...
def _run_superconductivity() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.superconductivity_adapter import SuperconductivityTraceAdapter
...
def _run_disordered() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.disordered_adapter import DisorderedTraceAdapter
...
def _run_surfaces() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.surfaces_adapter import SurfacesTraceAdapter
...
def _run_defects() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.defects_adapter import DefectsTraceAdapter
...
def _run_ferroelectrics() -> dict[str, Any]:
    from tensornet.condensed_matter.trace_adapters.ferroelectrics_adapter import FerroelectricsTraceAdapter
...
def _run_nuclear_structure() -> dict[str, Any]:
    from tensornet.nuclear.trace_adapters.nuclear_structure_adapter import NuclearStructureTraceAdapter
...
def _run_nuclear_reactions() -> dict[str, Any]:
    from tensornet.nuclear.trace_adapters.nuclear_reactions_adapter import NuclearReactionsTraceAdapter
...
def _run_nuclear_astro() -> dict[str, Any]:
    from tensornet.nuclear.trace_adapters.nuclear_astro_adapter import NuclearAstroTraceAdapter
...
def _run_lattice_qcd() -> dict[str, Any]:
    from tensornet.qft.trace_adapters.lattice_qcd_adapter import LatticeQCDTraceAdapter
...
def _run_perturbative_qft() -> dict[str, Any]:
    from tensornet.qft.trace_adapters.perturbative_qft_adapter import PerturbativeQFTTraceAdapter
...
def _run_beyond_sm() -> dict[str, Any]:
    from tensornet.particle.trace_adapters.beyond_sm_adapter import BeyondSmTraceAdapter
...
def _run_pes() -> dict[str, Any]:
    from tensornet.chemistry.trace_adapters.pes_adapter import PESTraceAdapter
...
def _run_reaction_rate() -> dict[str, Any]:
    from tensornet.chemistry.trace_adapters.reaction_rate_adapter import ReactionRateTraceAdapter
...
def _run_catalysis() -> dict[str, Any]:
    from tensornet.chemistry.trace_adapters.catalysis_adapter import CatalysisTraceAdapter
