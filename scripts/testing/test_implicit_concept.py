...
def eval_qtt_at_points_torch(qtt_cores: list, u: torch.Tensor, v: torch.Tensor) -> torch.Tensor:
    """
    ...
    for i in range(batch_size):
        ...
        for d in range(12):
            ...
            if mat.shape[0] == 1:
                ...
                mat_2x2 = mat[:2, :2] if mat.shape[0] >= 2 else torch.eye(2, device=u.device)
