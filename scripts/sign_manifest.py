...
class DilithiumSigner:
    ...
    def __init__(self, algorithm: str = 'Dilithium2'):
        if not PQC_AVAILABLE:
            raise RuntimeError("liboqs-python not available. Install with: pip install liboqs-python")
...
def main():
    ...
    parser.add_argument('--manifest', type=Path, required=True, help='Input manifest file')
    parser.add_argument('--algorithm', type=str, default='dilithium2', 
                       choices=['dilithium2', 'dilithium3', 'dilithium5', 'ecdsa'],
                       help='Signing algorithm')
    parser.add_argument('--output', type=Path, required=True, help='Output signed manifest')
