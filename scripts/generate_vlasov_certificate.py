...
Usage:
    python scripts/generate_vlasov_certificate.py --dims 6 --n-bits 5 --steps 100
    python scripts/generate_vlasov_certificate.py --dims 5 --n-bits 4 --steps 50
    python scripts/generate_vlasov_certificate.py --all  # Both 5D and 6D
