//! Shared Halo2 sub-circuit gadgets for all proof modules.
//!
//! Canonical implementations extracted from euler3d/ns_imex gadgets.
//! Each module re-exports from here to avoid 3× duplication.
//!
//! ## Shared Gadgets
//!
...
pub mod halo2_gadgets {
    ...
    impl FixedPointMACGadget {
        ...
        ///
        /// This assigns:
        /// - Row 0: c = accumulators[0] (initial accumulator, typically 0)
...
/// Stub types for non-Halo2 builds (STARK, no-ZK, etc.).
///
/// These provide type-level compatibility so that test code can import
/// gadget struct names without requiring the Halo2 dependency.
